...
,"최대인원"
,"등록일"
,{name:"Action",sort:{enabled:!1},formatter:function(a){return gridjs.html('<div class="d-flex gap-3"><a href="/host/lodgingView" data-bs-toggle="tooltip" data-bs-placement="top" title="수정" class="text-success"><i class="mdi mdi-pencil font-size-18"></i></a><a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="top" title="삭제" class="text-danger"><i class="mdi mdi-delete font-size-18"></i></a></div>')}}]
,pagination:{limit:7},sort:!0,search:!0
,data:[["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","2","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","3","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","4","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","5","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-26"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-21"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-22"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-23"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-24"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-25"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-28"]
	,["","1","해변근처","제주하르방","제주특별자치도 서귀포시 안덕면 사계북로 120","010-1234-1234","8인", "2022-04-27"]
