                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card">
                            <div class="card-body p-4"> 
                                ...
                                <div class="p-2 mt-4">
                                    <form action="hostInsert" method="get">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                <span class="bx bx-lock-alt"></span>
                                                <input type="password" class="form-control" id="tvmmPassword2" name="tvmmPassword2"  placeholder="비밀번호를 입력해주세요.">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                <span class="bx bx-lock-alt"></span>
                                                <input type="password" class="form-control" id="tvmmTelNumber" name="tvmmTelNumber" placeholder="전화번호를 입력해주세요.">
                                            </div>
                                        </div>
                                        <div class="mb-3">
        						...
        						<div class="input-group-append">
    								...
    								<div class="input-group mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                <span class="bx bx-lock-alt"></span>
                                                <input type="date" class="form-control" id="tvmmDob" name="tvmmDob" >
                                            </div>
                                        </div>
