                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    <li class="mm-active">
                                    	<a href="a_host_couponList.html" data-key="t-invoice-list" class="active">쿠폰 리스트</a>
                                    </li>
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative">
                                            <div class="modal-button mt-2">
                                                <a href="a_host_couponForm.html><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2 w-md" data-bs-target=".add-new-order">등록</button></a>
                                        ...
                                        <!-- js/pages/a_host_couponList.init.js 파일에 테이블 데이터있음 -->
