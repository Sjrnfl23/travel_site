                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    ...
                                    <li class="mm-active"><a href="a_host_couponBak.html" data-key="t-invoice-detail"  class="active">쿠폰 내역</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- js/pages/a_host_couponListBak.init.js 파일에 테이블 데이터있음 -->
...
<!--                  successfully modal 
        ...
        <script src="../../resources/host/js/pages/a_host_couponListBak.init.js"></script>
