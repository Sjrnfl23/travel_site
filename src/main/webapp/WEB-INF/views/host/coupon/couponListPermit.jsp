                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    <li >
                                    	<a href="couponList.html" data-key="t-invoice-list" >쿠폰 리스트</a>
                                    </li>
                                    <li><a href="couponForm.html" data-key="t-invoice-list">쿠폰 등록</a></li>
                                    <li class="mm-active"><a href="couponListPermit.html" data-key="t-invoice-detail" class="active">쿠폰 승인</a></li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- js/pages/couponListPermit.init.js 파일에 테이블 데이터있음 -->
