                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-4 pt-0">
                                            ...
                                            <div class="mt-n5 position-relative text-center border-bottom pb-3">
                                               <img src="/resources/admin/memberUploaded/admin/<c:out value="${sessYear2}"/>/<c:out value="${sessMonth2}"/>/<c:out value="${sessDay2}"/>/<c:out value="${sessUuidName2}"/>" alt="" class="avatar-xl rounded-circle img-thumbnail">
                                            ...
                                            <div class="mt-3 pt-1 text-center">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item">
                                                    	<a href="/admin/adminInfoView?tvmmSeq=<c:out value="${rt.tvmmSeq}"/>">
