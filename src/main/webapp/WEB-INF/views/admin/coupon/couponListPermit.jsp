                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">쿠폰 승인</h4>
                        </div>
                        <!-- end page title -->
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    ...
                                    <li class="mm-active"><a href="couponListPermit.jsp" data-key="t-invoice-detail" class="active">쿠폰 승인</a></li>
                                    <li><a href="couponListBak.jsp" data-key="t-invoice-detail">쿠폰 내역</a></li>
                                </ul>
                            </li>
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative">
                                            <div class="modal-button mt-2">
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".add-new-order">선택 승인</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".add-new-order">선택 거절</button>
                                            </div>
                                        </div>
                                        <!-- js/pages/admin_couponListPermit.init.js 파일에 테이블 데이터있음 -->
...
<!--                  successfully modal 
        ...
        <script src="../../../../resources/admin/assets/js/pages/admin_couponListPermit.init.js"></script>
