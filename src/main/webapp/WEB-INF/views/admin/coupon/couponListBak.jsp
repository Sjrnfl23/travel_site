                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">지난 쿠폰 내역</h4>
                        </div>
                        <!-- end page title -->
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    ...
                                    <li class="mm-active"><a href="couponBak" data-key="t-invoice-detail"  class="active">쿠폰 내역</a></li>
                                </ul>
                            </li>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- js/pages/admin_couponListBak.init.js 파일에 테이블 데이터있음 -->
...
<!--                  successfully modal 
        ...
        <script src="../../../../resources/admin/assets/js/pages/admin_couponListBak.init.js"></script>
