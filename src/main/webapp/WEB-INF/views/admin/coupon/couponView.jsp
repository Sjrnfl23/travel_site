                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">쿠폰 상세</h4>
                        </div>
                        <!-- end page title -->
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="../reservation/lodgingList.jsp" data-key="t-products">숙소 리스트</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu mm-collapse mm-show" aria-expanded="false">
                                    <li class="mm-active">
                                    	<a href="couponList.jsp" data-key="t-invoice-list" class="active">쿠폰 리스트</a>
                                    </li>
