                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">숙소 리스트</h4>
                        </div>
                        <!-- end page title -->
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu mm-active" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="../member/memberList.jspl" data-key="t-user-list">사용자 관리</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- js/pages/admin_lodgingList.init.js 파일에 테이블 데이터있음 -->
