                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="page-title-box align-self-center d-none d-md-block">
                            <h4 class="page-title mb-0">사용자 리스트</h4>
                        </div>
                        <!-- end page title -->
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li class="mm-active">
                                    	<a href="../coupon/couponList.jsp" data-key="t-invoice-list" >쿠폰 리스트</a>
                                    </li>
                            ...
                            <li class="mm-active">
                                ...
                                <ul class="sub-menu  mm-collapse mm-show" aria-expanded="false">
                                    ...
                                    <li><a href="member/memberList.jsp" data-key="t-user-list" class="active">사용자 관리</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="position-relative">
                                            <div class="modal-button mt-2">
                                                <a href="memberForm.jsp"><button type="button" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2" data-bs-toggle="modal" data-bs-target=".add-new-order">+ 등록</button></a>
                                        ...
                                        <!-- js/pages/admin_memberList.init.js 파일에 테이블 데이터있음 -->
...
<!--                  successfully modal 
        ...
        <script src="../../../../resources/admin/assets/js/pages/admin_memberList.init.js"></script>
