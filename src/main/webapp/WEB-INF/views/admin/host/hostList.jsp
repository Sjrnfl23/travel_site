...
<form id="formList" name="formList" action="/admin/hostList">
...
<script type="text/javascript">
	var goUrlList = "/admin/hostList";
	var goUrlForm = "/admin/hostForm";
	var goUrlMultiDel = "/admin/hostMultiDel";
