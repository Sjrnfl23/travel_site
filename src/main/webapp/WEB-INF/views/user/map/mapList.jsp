                    ...
                    <div class="row detail-filter-wrap">
						...
						<div class="col-md-8 featured-responsive">
                            <div class="detail-filter">
                                <a class="btn btn-outline-danger" href="mapForm.html" role="button"><span class="ti-pencil"></span>기록</a>
                            </div>
                        </div>
                    </div>
                    	<div class="bgt">
	                        <div class="col-md-6">
                                ...
                                <a href="detail.html"><img class="card-img-top img_inside" src="/resources/user/images/cherryblossom.jpg" alt="Card image cap"></a>
	                                <div class="card-body">
