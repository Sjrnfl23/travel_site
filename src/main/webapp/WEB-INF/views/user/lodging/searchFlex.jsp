	                ...
	                <div class="col-md-12 responsive-wrap">
	                    ...
	                    <c:forEach items="${list}" var="item" varStatus="status">
	                        <div class="col-md-4 card-2">
	                            <!-- card-1 -->
	                            <div class="card">
	                                <a href="/lodgingView?tvamSeq=<c:out value="${item.tvamSeq}"/>"><img class="card-img-top" src="/resources/admin/memberUploaded/admin/<c:out value="${item.year}"/>/<c:out value="${item.month}"/>/<c:out value="${item.day}"/>/<c:out value="${item.uuidName}"/> " alt="Card image cap"></a>
