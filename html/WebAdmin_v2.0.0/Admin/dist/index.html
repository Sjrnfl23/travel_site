        ...
        <div id="layout-wrapper">
            ...
            <div class="vertical-menu">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="assets/images/nowtravel_logo_180.jpg" alt="" height="26">
                        </span>
                        <span class="logo-lg">
                            <img src="assets/images/nowtravel_logo_180.jpg" alt="">
                        </span>
                    </a>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="ecommerce-products.html" data-key="t-products">숙소 리스트</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="invoices-list.html" data-key="t-invoice-list">쿠폰 리스트</a></li>
                                    <li><a href="invoices-detail.html" data-key="t-invoice-detail">쿠폰 승인</a></li>
                                    <li><a href="invoices-detail.html" data-key="t-invoice-detail">쿠폰 내역</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="contacts-grid.html" data-key="t-user-grid">호스트 관리</a></li>
                                    <li><a href="contacts-list.html" data-key="t-user-list">사용자 관리</a></li>
                                </ul>
                            </li>
